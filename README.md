...
<div style="display: flex; flex-wrap: wrap; gap: 20px; margin: 20px 0;">
  <div style="flex: 1; min-width: 300px;">
    ...
    <img src="docs/images/home.png" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" alt="主界面">
  </div>
  <div style="flex: 1; min-width: 300px;">
    <h4 align="center">编辑 Cookie</h4>
    <img src="docs/images/edit.png" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" alt="编辑 Cookie">
  </div>
</div>
...
**实际上是个学习扩展开发的基本项目，功能很简陋。readme 随便由 AI **
